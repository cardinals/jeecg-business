...
@Service("tBBusiCatalogService")
@Transactional
public class TBBusiCatalogServiceImpl extends CommonServiceImpl implements TBBusiCatalogServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TBBusiCatalogEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(TBBusiCatalogEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	...
	private void doDelBus(TBBusiCatalogEntity t) throws Exception{
 	...
 	private Map<String,Object> populationMap(TBBusiCatalogEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TBBusiCatalogEntity t){
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("t_b_busi_catalog",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,TBBusiCatalogEntity t){
