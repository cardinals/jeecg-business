...
@Service("tBBusiWorkreportService")
@Transactional
public class TBBusiWorkreportServiceImpl extends CommonServiceImpl implements TBBusiWorkreportServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(TBBusiWorkreportEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(TBBusiWorkreportEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(TBBusiWorkreportEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(TBBusiWorkreportEntity t){
		...
		map.put("un_done_today", t.getUnDoneToday());
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,TBBusiWorkreportEntity t){
 		...
 		sql  = sql.replace("#{un_done_today}",String.valueOf(t.getUnDoneToday()));
	 ...
	 */
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("t_b_busi_workreport",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
 	...
 	private void executeSqlEnhance(String sqlEnhance,TBBusiWorkreportEntity t){
