  ...
  <div class="main-content">
    <div class="row">
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container" style="position: relative; z-index: 4; margin-top: 15%; margin-right: 0;">
          <div class="center">
            <h2 id="id-text2" style="color: #fff; font-weight: bold;">
          ...
          <div class="position-relative">
            <div id="login-box" class="login-box visible widget-box no-border">
              <div class="widget-body">
                ...
                <%--注释渐变色版本 style="background-image:linear-gradient(to right,white,gainsboro,white);--%>
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix">
                        <label class="inline">
                          ...
                          <span class="lbl" style="color: #0a0a0a; font-weight: bold;">记住我</span>
                        </label>
                        ...
                        <a href="loginController.do?goResetPwdMail" class="btn btn-link pull-right" style="color: #0a0a0a; font-size: 10px;">忘记密码</a>
                      </div>
                        <div class="clearfix">
                            <button type="button" id="but_login"  onclick="checkUser()" style="background-color: #18bbde; color: #fff; width: 100%; border-color: #18bbde; height: 35px;">
