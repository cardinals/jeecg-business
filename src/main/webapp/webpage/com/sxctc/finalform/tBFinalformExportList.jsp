...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBFinalformExportList" checkbox="false" pagination="true" fitColumns="false" title="财务报表导出" actionUrl="tBFinalformExportController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="合计收入(万元)"  field="totalCoiunt"  queryMode="single"  width="150" align="center"></t:dgCol>
