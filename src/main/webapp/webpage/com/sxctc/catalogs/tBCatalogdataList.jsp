...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBCatalogdataList" checkbox="true" pagination="true" treegrid="true" treeField="name" fitColumns="true" title="服务目录管理" actionUrl="tBCatalogdataController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="tBCatalogdataController.do?goAdd" funname="add"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tBCatalogdataController.do?goUpdate" funname="updatetree" width="100%" height="100%"></t:dgToolBar>
   ...
   <t:dgToolBar title="查看" icon="icon-search" url="tBCatalogdataController.do?goUpdate" funname="detailtree" width="100%" height="100%"></t:dgToolBar>
