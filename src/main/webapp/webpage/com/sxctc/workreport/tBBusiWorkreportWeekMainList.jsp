...
<div class="easyui-layout" fit="true">
   ...
   <iframe id="mainList" src="${webRoot}/tBWorkreportdayWeekController.do?list&toolFlag=1" frameborder="0" height="70%" width="100%"></iframe>
   <div id="accDiv" class="easyui-accordion" style="padding-right:15px;overflow-x:hidden;box-sizing: border-box;">
		<div title="个人周报" data-options="iconCls:'icon-ok'" style="overflow:auto;box-sizing: border-box;">
			<iframe id="customerList" height="250" src="${webRoot}/tBWorkreportdayWeekController.do?list&toolFlag=0" frameborder="0" width="100%" ></iframe>
		</div>
