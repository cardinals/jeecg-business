 ...
 <body>
		...
		<table style="width: 100%;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
                            <input id="reportStartDate" name="reportStartDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" readonly="readonly" value='<fmt:formatDate value='${tBWorkreportdayWeekPage.reportStartDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
                            <input id="reportEndDate" name="reportEndDate" type="text" style="width: 150px"  class="Wdate" onClick="WdatePicker()"  ignore="ignore" readonly="readonly" value='<fmt:formatDate value='${tBWorkreportdayWeekPage.reportEndDate}' type="date" pattern="yyyy-MM-dd"/>'/>
							<span class="Validform_checktip"></span>
