 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
							<t:dictSelect field="unitCode" type="list"  typeGroupCode="unit_name"   defaultVal="${tBBusiWorkreportPage.unitCode}" hasLabel="false"  title="厅局单位"></t:dictSelect>
					...
					<tr>
						...
						<td class="value">
							<textarea id="doneToday" style="width:100%;height: 260px;" class="inputxt" rows="6" name="doneToday"  ignore="checked" >${tBBusiWorkreportPage.doneToday}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<textarea id="unDoneToday" style="width:100%;height: 260px;" class="inputxt" rows="6" name="unDoneToday"  ignore="checked" >${tBBusiWorkreportPage.unDoneToday}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<textarea id="coordinateWork" style="width:100%;height: 260px;" class="inputxt" rows="6" name="coordinateWork"  ignore="checked" >${tBBusiWorkreportPage.coordinateWork}</textarea>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
							<textarea id="remark" style="width:100%;height: 260px;" class="inputxt" rows="6" name="remark"  ignore="checked" >${tBBusiWorkreportPage.remark}</textarea>
							<span class="Validform_checktip"></span>
