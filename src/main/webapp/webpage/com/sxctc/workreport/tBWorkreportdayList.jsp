...
<div class="easyui-layout" fit="true">
  ...
  <%--<t:dgToolBar title="录入" icon="icon-add" url="tBWorkreportdayController.do?goAdd" funname="add"></t:dgToolBar>
   ...
   <c:if test="${empty toolFlag}">
    <t:datagrid name="tBWorkreportdayList" checkbox="true" pagination="true" fitColumns="false" title="日志报表" actionUrl="tBWorkreportdayController.do?datagrid&busiReportId=${busiReportId}" idField="id" fit="true" queryMode="group">
     <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
     <t:dgCol title="创建人名称"  field="createName" queryMode="single" width="120"></t:dgCol>
     <t:dgCol title="创建人登录名称"  field="createBy"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
     <t:dgCol title="日报时间"  field="reportDate"  formatter="yyyy-MM-dd" queryMode="single"  width="120"></t:dgCol>
     ...
     <t:dgCol title="所属部门"  field="sysOrgCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
     <t:dgCol title="所属公司"  field="sysCompanyCode"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
     <t:dgCol title="日志类型"  field="reportType" queryMode="single" dictionary="reportType"  width="120"></t:dgCol>
     <t:dgCol title="厅局单位"  field="unitCode" queryMode="single" dictionary="unit_name"  width="120"></t:dgCol>
     <t:dgCol title="迁移系统名称"  field="projectName" queryMode="single" width="120"></t:dgCol>
     <t:dgCol title="完成的工作"  field="doneDay"  queryMode="single"  width="350"></t:dgCol>
     <t:dgCol title="未完成的工作"  field="unDoneDay"  queryMode="single"  width="350"></t:dgCol>
     <t:dgCol title="需要协调的工作"  field="coordinateWork"  queryMode="single"  width="350"></t:dgCol>
     <t:dgCol title="备注"  field="remark"  queryMode="single"  width="350"></t:dgCol>
     <t:dgCol title="日志业务关联表id"  field="busiReportId"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
