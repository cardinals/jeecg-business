...
<div class="easyui-layout" fit="true">
  <div region="center" style="padding:0px;border:0px;height:550px;">
  <t:datagrid name="tBChancePoolList" checkbox="false" pagination="true" fitColumns="true" title="项目机会池" actionUrl="tBChancePoolController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="商机评估要素1win"  field="evaluateWin"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="商机评估要素3first"  field="evaluateFirst"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="商机评估要素9confirm"  field="evaluateConfirm"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="tBChancePoolContgoEvaluateroller.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="评估"  icon="icon-remove"  url="tBChancePoolController.do?"   funname="evaluateTheproj"></t:dgToolBar>
 ...
 function evaluateTheproj(title,url, id,width,height,isRestful) {
     gridname=id;
