...
<script src="${webRoot}/plug-in/themes/bootstrap-ext/js/common.js"></script>
 ...
 <form id="formobj" action="tBWorkdayController.do?doUpdate" class="form-horizontal validform" role="form"  method="post">
	<input type="hidden" id="btn_sub" class="btn_sub"/>
	<input type="hidden" id="id" name="id" value="${tBWorkdayPage.id}"/>
	<div class="form-group">
		<label for="createName" class="col-sm-3 control-label">创建人名称：</label>
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="createName" name="createName" value='${tBWorkdayPage.createName}' type="text" maxlength="50" class="form-control input-sm" placeholder="请输入创建人名称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
      		    <input id="createDate" name="createDate" type="text" class="form-control input-sm" placeholder="请输入创建日期"  ignore="ignore"  value="<fmt:formatDate pattern='yyyy-MM-dd' type='date' value='${tBWorkdayPage.createDate}'/>" />
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
               <t:dictSelect field="xiangmudanwei" type="list" extendJson="{class:'form-control input-sm'}"   typeGroupCode=""  hasLabel="false"  title="项目单位名称" defaultVal="${tBWorkdayPage.xiangmudanwei}"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="xiangmu" name="xiangmu" value='${tBWorkdayPage.xiangmu}' type="text" maxlength="128" class="form-control input-sm" placeholder="请输入项目名称"  ignore="ignore" />
			</div>
		</div>
	</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea id="jinri" name="jinri" class="form-control" placeholder="请输入今日工作内容" rows="4">${tBWorkdayPage.jinri}</textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea id="jinrizongjie" name="jinrizongjie" class="form-control" placeholder="请输入今日工作总结" rows="4">${tBWorkdayPage.jinrizongjie}</textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea id="tojihua" name="tojihua" class="form-control" placeholder="请输入明天工作计划" rows="4">${tBWorkdayPage.tojihua}</textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea id="xvyao" name="xvyao" class="form-control" placeholder="请输入需要帮助和支持" rows="4">${tBWorkdayPage.xvyao}</textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<textarea id="beizhu" name="beizhu" class="form-control" placeholder="请输入备注" rows="4">${tBWorkdayPage.beizhu}</textarea>
				</div>
			</div>
		</div>
</form>
