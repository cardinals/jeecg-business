...
<script src="${webRoot}/plug-in/themes/bootstrap-ext/js/common.js"></script>
 ...
 <form id="formobj" action="tBCatalogdataController.do?doUpdate" class="form-horizontal validform" role="form"  method="post">
	<input type="hidden" id="btn_sub" class="btn_sub"/>
	<input type="hidden" id="id" name="id" value="${tBCatalogdataPage.id}"/>
	<div class="form-group">
		<label for="name" class="col-sm-3 control-label">名称：</label>
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="name" name="name" value='${tBCatalogdataPage.name}' type="text" maxlength="100" class="form-control input-sm" placeholder="请输入名称"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="danwei" name="danwei" value='${tBCatalogdataPage.danwei}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入单位"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="fartherid" name="fartherid" value='${tBCatalogdataPage.fartherid}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入父节点ID"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="num" name="num" value='${tBCatalogdataPage.num}' type="text" maxlength="32" class="form-control input-sm" placeholder="请输入数量"  datatype="n"  ignore="ignore" />
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<input id="beizhu" name="beizhu" value='${tBCatalogdataPage.beizhu}' type="text" maxlength="80" class="form-control input-sm" placeholder="请输入备注"  ignore="ignore" />
			</div>
		</div>
	</div>
</form>
