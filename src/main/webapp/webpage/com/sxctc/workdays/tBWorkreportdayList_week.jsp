...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBWorkreportdayList" checkbox="true" pagination="true" fitColumns="true" title="周报管理" actionUrl="tBWorkreportdayweekController.do?datagrid" idField="id" fit="true" queryMode="group">
...
//导入
function ImportXls() {
	openuploadwin('Excel导入', 'tBWorkreportdayweekController.do?upload', "tBWorkreportdayList");
}

//导出
function ExportXls() {
	JeecgExcelExport("tBWorkreportdayweekController.do?exportXls","tBWorkreportdayList");
}

//模板下载
function ExportXlsByT() {
	JeecgExcelExport("tBWorkreportdayweekController.do?exportXlsByT","tBWorkreportdayList");
}
