...
<form id="formobj" action="tBBusinessController.do?doAdd" class="form-horizontal validform" role="form"  method="post">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				...
				<t:dictSelect id="unitCode" field="unitCode" type="list" extendJson="{class:'form-control input-sm'}"    typeGroupCode="unit_name"  hasLabel="false"  title="厅局名称"  datatype="*"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:dictSelect id="projectStatus" field="projectStatus" type="radio" typeGroupCode="proj_type"  hasLabel="false"  title="厅局名称"  datatype="*"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:dictSelect id="cloudStatus" field="cloudStatus" type="radio"  typeGroupCode="dev_flag" defaultVal="1"  hasLabel="false"  title="是否上云"  datatype="*"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:dictSelect id="chanceStatus" field="chanceStatus" type="radio"  typeGroupCode="dev_flag" hasLabel="false"  title="是否上云"  datatype="*"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
		...
		<div class="col-sm-7">
			<div class="input-group" style="width:100%">
				<t:dictSelect id="joinStatus" field="joinStatus" type="radio"  typeGroupCode="joinStatus"  hasLabel="false"  title="是否上云"  datatype="*"></t:dictSelect>
			</div>
		</div>
	</div>
	<div class="form-group">
	...
	<div id="checkContent">
		<div class="form-group">
			...
			<div class="col-sm-7">
				<div class="input-group" style="width:100%">
					<input id="busJoinTime" name="busJoinTime" type="text" class="form-control input-sm" placeholder="请输入业务对接时间" ignore="checked" />
					<span class="input-group-addon" >
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
				</div>
