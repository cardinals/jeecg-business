 ...
 <body>
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<tr>
						...
						<td class="value">
									<t:dictSelect field="auditStatus" type="radio"  datatype="n"  typeGroupCode="dev_flag"   defaultVal="${tBBusinessPage.auditStatus}" hasLabel="false"  title="是否在审计范围" ></t:dictSelect>     
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">是否在审计范围</label>
						</td>
				<td align="right">
					<label class="Validform_label">
					</label>
