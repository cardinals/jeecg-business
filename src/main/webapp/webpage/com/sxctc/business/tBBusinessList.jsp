...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tBBusinessList" checkbox="true" pagination="true" fitColumns="true" title="营销数据业务列表" actionUrl="tBBusinessController.do?datagrid" idField="id" fit="true" queryMode="group">
   <t:dgCol title="主键"  field="id"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="创建人名称"  field="createName"   queryMode="single"  width="60"></t:dgCol>
   ...
   <t:dgCol title="厅局名称"  field="unitName"  hidden="true"  queryMode="single"  width="120"></t:dgCol>
   ...
   <t:dgCol title="系统类型"  field="projectStatus"  queryMode="single"  dictionary="proj_type"  width="50"></t:dgCol>
   <t:dgCol title="是否上云"  field="cloudStatus"  queryMode="single"  dictionary="dev_flag"  width="50"></t:dgCol>
   <t:dgCol title="是否有机会"  field="chanceStatus"  queryMode="single"  dictionary="dev_flag"  width="50"></t:dgCol>
   <t:dgCol title="对接状态"  field="joinStatus"  queryMode="single"  dictionary="joinStatus"  width="50" extendParams="styler:fmtype"></t:dgCol>
   <t:dgCol title="业务创建时间"  field="busCreateTime"  formatter="yyyy-MM-dd"  queryMode="single"  width="80"></t:dgCol>
   <t:dgCol title="业务对接时间"  field="busJoinTime"  formatter="yyyy-MM-dd"  queryMode="single"  width="80"></t:dgCol>
   ...
   <t:dgCol title="是否收回协议"  field="protocolStatus"  queryMode="single"  dictionary="dev_flag"  width="50"></t:dgCol>
   <t:dgCol title="收回协议时间"  field="protocolTime"  formatter="yyyy-MM-dd"  queryMode="single"  width="80"></t:dgCol>
   ...
   <t:dgFunOpt title="服务目录" urlclass="ace_button" urlfont="fa-trash-o" funname="checkCatalog(id)" operationCode="add" exp="joinStatus#eq#1"></t:dgFunOpt>
